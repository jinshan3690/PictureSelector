...
public class PictureParameterStyle {
     ...
     * @return
     */
    public static PictureParameterStyle ofNewStyleLight(Boolean pictureExternalPreviewGonePreviewDelete) {
        PictureParameterStyle uiStyle = new PictureParameterStyle();
        // 开启新选择风格
        uiStyle.isNewSelectStyle = true;
        // 是否改变状态栏字体颜色(黑白切换)
        ...
        uiStyle.pictureTitleBarBackgroundColor = Color.parseColor("#FFFFFF");
        // 相册父容器背景色
        uiStyle.pictureContainerBackgroundColor = Color.parseColor("#f2f2f2");
        // 相册列表标题栏右侧上拉箭头
        uiStyle.pictureTitleUpResId = R.drawable.picture_icon_wechat_up;
        // 相册列表标题栏右侧下拉箭头
        uiStyle.pictureTitleDownResId = R.drawable.picture_icon_wechat_down;
        // 相册文件夹列表选中圆点
        uiStyle.pictureFolderCheckedDotStyle = R.drawable.picture_num_oval_yellow;
        // 相册返回箭头
        uiStyle.pictureLeftBackIcon = R.drawable.picture_icon_back_arrow;
        // 标题栏字体颜色
        uiStyle.pictureTitleTextColor = Color.parseColor("#000000");
        ...
        uiStyle.pictureCancelTextColor = Color.parseColor("#000000");
        // 相册右侧按钮字体默认颜色
        uiStyle.pictureRightDefaultTextColor = Color.parseColor("#000000");
        // 相册右侧按可点击字体颜色,只针对isWeChatStyle 为true时有效果
        uiStyle.pictureRightSelectedTextColor = Color.parseColor("#000000");
        // 相册右侧按钮背景样式,只针对isWeChatStyle 为true时有效果
        uiStyle.pictureUnCompleteBackgroundStyle = R.drawable.picture_send_button_default_bg_light;
        // 相册右侧按钮可点击背景样式,只针对isWeChatStyle 为true时有效果
        uiStyle.pictureCompleteBackgroundStyle = R.drawable.picture_send_button_bg_light;
        // 选择相册目录背景样式
        uiStyle.pictureAlbumStyle = R.drawable.picture_item_select_bg;
        // 相册列表勾选图片样式
        uiStyle.pictureCheckedStyle = R.drawable.picture_wechat_num_selector_light;
        // 相册标题背景样式 ,只针对isWeChatStyle 为true时有效果
        uiStyle.pictureWeChatTitleBackgroundStyle = R.drawable.picture_album_bg_light;
        // 微信样式 预览右下角样式 ,只针对isWeChatStyle 为true时有效果
        uiStyle.pictureWeChatChooseStyle = R.drawable.picture_wechat_select_cb_light;
        // 相册返回箭头 ,只针对isWeChatStyle 为true时有效果
        uiStyle.pictureWeChatLeftBackStyle = R.drawable.picture_icon_back_arrow;
        // 相册列表底部背景色
        uiStyle.pictureBottomBgColor = Color.parseColor("#FFFFFF");
        // 已选数量圆点背景样式
        uiStyle.pictureCheckNumBgStyle = R.drawable.picture_num_oval;
        // 相册列表底下预览文字色值(预览按钮可点击时的色值)
        uiStyle.picturePreviewTextColor = Color.parseColor("#000000");
        // 相册列表底下不可预览文字色值(预览按钮不可点击时的色值)
        uiStyle.pictureUnPreviewTextColor = Color.parseColor("#9b9b9b");
        // 相册列表已完成色值(已完成 可点击色值)
        uiStyle.pictureCompleteTextColor = Color.parseColor("#000000");
        // 相册列表未完成色值(请选择 不可点击色值)
        uiStyle.pictureUnCompleteTextColor = Color.parseColor("#53575e");
        // 预览界面底部背景色
        uiStyle.picturePreviewBottomBgColor = Color.parseColor("#a0393a3e");
        // 外部预览界面删除按钮样式
        uiStyle.pictureExternalPreviewDeleteStyle = R.drawable.picture_del_light;
        // 原图按钮勾选样式  需设置.isOriginalImageControl(true); 才有效
        uiStyle.pictureOriginalControlStyle = R.drawable.picture_original_wechat_checkbox;
        // 原图文字颜色 需设置.isOriginalImageControl(true); 才有效
        uiStyle.pictureOriginalFontColor = Color.parseColor("#000000");
        // 外部预览界面是否显示删除按钮
        uiStyle.pictureExternalPreviewGonePreviewDelete = pictureExternalPreviewGonePreviewDelete;
        // 设置NavBar Color SDK Build.VERSION.SDK_INT >= Build.VERSION_CODES.LOLLIPOP有效
        uiStyle.pictureNavBarColor = Color.parseColor("#393a3e");
        return uiStyle;
    }
