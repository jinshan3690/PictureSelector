...
public class PictureSelectorUIStyle {
     ...
     * 标题栏右侧按钮默认文案
     */
    public String picture_top_titleRightDefaultText;

    /**
     * 标题栏右侧按钮正常文案(可点击)
     */
    public String picture_top_titleRightNormalText;
     ...
     * 底部预览默认文字
     */
    public String picture_bottom_previewDefaultText;

    /**
     * 底部预览文字(可点击)
     */
    public String picture_bottom_previewNormalText;
     ...
     * 原图文案
     */
    public String picture_bottom_originalPictureText;
     ...
     * 完成默认文案
     */
    public String picture_bottom_completeDefaultText;

    /**
     * 完成正常文案(可点击)
     */
    public String picture_bottom_completeNormalText;
     ...
     * 选择按钮文案(新样式支持)
     */
    public String picture_bottom_selectedText;
     ...
     * adapter 拍照文案
     */
    public String picture_adapter_item_camera_text;
    /**
     * adapter 拍照文字大小
     */
    ...
    public static PictureSelectorUIStyle ofSelectTotalStyle() {
        ...
        if (appContext != null) {
            ...
            uiStyle.picture_bottom_previewNormalText = appContext.getString(R.string.picture_preview_num);
            uiStyle.picture_bottom_originalPictureText = appContext.getString(R.string.picture_original_image);
            uiStyle.picture_bottom_completeDefaultText = appContext.getString(R.string.picture_done);
            uiStyle.picture_bottom_completeNormalText = appContext.getString(R.string.picture_done_front_num);
            uiStyle.picture_adapter_item_camera_text = appContext.getString(R.string.picture_take_picture);
        }
     ...
     * @return
     */
    public static PictureSelectorUIStyle ofNewStyleLight() {
        PictureSelectorUIStyle uiStyle = new PictureSelectorUIStyle();
        ...
        uiStyle.picture_container_backgroundColor = Color.parseColor("#f2f2f2");

        uiStyle.picture_navBarColor = Color.parseColor("#FFFFFF");

        uiStyle.picture_switchSelectNumberStyle = true;

        uiStyle.picture_check_style = R.drawable.picture_wechat_num_selector_light;
        uiStyle.picture_check_textColor = Color.parseColor("#000000");
        ...
        uiStyle.picture_top_titleTextColor = Color.parseColor("#000000");
        uiStyle.picture_top_titleBarBackgroundColor = Color.parseColor("#FFFFFF");
        uiStyle.picture_top_titleAlbumBackground = R.drawable.picture_album_bg_light;
        ...
        uiStyle.picture_bottom_previewTextSize = 16;
        uiStyle.picture_bottom_previewTextColor = new int[]{Color.parseColor("#9b9b9b"), Color.parseColor("#000000")};
        ...
        uiStyle.picture_bottom_completeRedDotBackground = R.drawable.picture_num_oval_yellow;
        uiStyle.picture_adapter_item_textSize = 12;
        uiStyle.picture_adapter_item_textColor = Color.parseColor("#FFFFFF");
        uiStyle.picture_adapter_item_video_textLeftDrawable = R.drawable.picture_icon_video;
        uiStyle.picture_adapter_item_audio_textLeftDrawable = R.drawable.picture_icon_audio;
        ...
        uiStyle.picture_bottom_originalPictureTextSize = 14;
        uiStyle.picture_bottom_originalPictureCheckStyle = R.drawable.picture_original_wechat_checkbox_light;
        uiStyle.picture_bottom_originalPictureTextColor = Color.parseColor("#000000");
        uiStyle.picture_top_titleRightTextDefaultBackground = R.drawable.picture_send_button_default_bg_light;
        uiStyle.picture_top_titleRightTextNormalBackground = R.drawable.picture_send_button_bg_light;
        ...
        if (appContext != null) {
            ...
            uiStyle.picture_bottom_selectedText = appContext.getString(R.string.picture_select);
            uiStyle.picture_bottom_selectedTextColor = Color.parseColor("#000000");
            uiStyle.picture_bottom_selectedTextSize = 16;
            uiStyle.picture_bottom_selectedCheckStyle = R.drawable.picture_wechat_select_cb_light;

            uiStyle.picture_bottom_gallery_height = ScreenUtils.dip2px(appContext, 80);
            uiStyle.picture_bottom_gallery_backgroundColor = Color.parseColor("#a0393a3e");
            uiStyle.picture_bottom_gallery_frameBackground = R.drawable.picture_preview_gallery_border_bg_light;
        }
